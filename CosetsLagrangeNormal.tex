...
\begin{center}
$a\sim_L b$ iff $a^{-1}b\in H$ for all $a,b\in G$
\end{center}
and
\begin{center}
$a\sim_R b$ iff $ab^{-1}\in H$ for all $a,b\in G$.
\end{center}
...
\begin{theorem}
Let $G$ be a group, $H\leq G$, and $a\in G$.  Define $\phi:H\to aH$ via $\phi(g)=ag$.  Then $\phi$ is one-to-one and onto.
\end{theorem}

...
\begin{theorem}
Suppose $G_1, G_2,\ldots, G_n$ are groups and let $(g_1,g_2,\ldots, g_n)\in \prod_{i=1}^nG_i$.  If $|a_i|=r_i<\infty$, then $|(a_1,a_2,\ldots, a_n)|=\lcm(a_1,a_2,\ldots,a_n)$.
\end{theorem}
...
\begin{theorem}
Suppose $G_1$ and $G_2$ are groups such that $H_1\leq G_1$ and $H_2\leq G_2$.  The $H_1\times H_2\leq G_1\times G_2$.
\end{theorem}
...
%\begin{section}{Revisiting Abelian Groups}
%
%yada yada
%
%\end{section}

...
$1$ & \cellcolor{cb-green}$1$ & \cellcolor{cb-green}$-1$ & \cellcolor{cb-purple}$i$ & \cellcolor{cb-purple}$-i$ & \cellcolor{cb-orange}$j$ & \cellcolor{cb-orange}$-j$ & \cellcolor{purple}$k$ & \cellcolor{purple}$-k$\\
\hline $-1$ & \cellcolor{cb-green}$-1$ & \cellcolor{cb-green}$1$ & \cellcolor{cb-purple}$-i$ & \cellcolor{cb-purple}$i$ & \cellcolor{cb-orange}$-j$ & \cellcolor{cb-orange}$j$ & \cellcolor{purple}$-k$ & \cellcolor{purple}$k$ \\
\hline $i$ & \cellcolor{cb-purple}$i$ & \cellcolor{cb-purple}$-i$ & \cellcolor{cb-green}$-1$ & \cellcolor{cb-green}$1$ & \cellcolor{purple}$k$ & \cellcolor{purple}$-k$ & \cellcolor{cb-orange}$-j$ & \cellcolor{cb-orange} $j$\\
\hline $-i$ & \cellcolor{cb-purple}$-i$ & \cellcolor{cb-purple}$i$ & \cellcolor{cb-green}$1$ & \cellcolor{cb-green}$-1$ & \cellcolor{purple}$-k$ & \cellcolor{purple}$k$ & \cellcolor{cb-orange}$j$ & \cellcolor{cb-orange}$-j$\\
\hline $j$ & \cellcolor{cb-orange}$j$ & \cellcolor{cb-orange}$-j$ & \cellcolor{purple}$-k$ & \cellcolor{purple}$k$ & \cellcolor{cb-green}$-1$ & \cellcolor{cb-green}$1$ & \cellcolor{cb-purple}$i$ & \cellcolor{cb-purple}$-i$\\
\hline $-j$ & \cellcolor{cb-orange}$-j$ & \cellcolor{cb-orange}$j$ & \cellcolor{purple}$k$ & \cellcolor{purple}$-k$ & \cellcolor{cb-green}$1$ & \cellcolor{cb-green}$-1$ & \cellcolor{cb-purple}$-i$ & \cellcolor{cb-purple}$i$\\
\hline $k$ & \cellcolor{purple}$k$ & \cellcolor{purple}$-k$ & \cellcolor{cb-orange}$j$ & \cellcolor{cb-orange}$-j$ & \cellcolor{cb-purple}$-i$ & \cellcolor{cb-purple}$i$ & \cellcolor{cb-green}$-1$ & \cellcolor{cb-green}$1$\\
\hline $-k$ & \cellcolor{purple}$-k$ & \cellcolor{purple}$k$ & \cellcolor{cb-orange}$-j$ & \cellcolor{cb-orange}$j$ & \cellcolor{cb-purple}$i$ & \cellcolor{cb-purple}$-i$ & \cellcolor{cb-green}$1$ & \cellcolor{cb-green}$-1$
\end{tabular}
\end{center}

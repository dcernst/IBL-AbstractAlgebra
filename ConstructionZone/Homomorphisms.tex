...
\begin{theorem}\label{thm:hom properties}
...
\draw (0,1) -- (0,5) -- (2.5,5) -- (2.5,1) -- (0,1);
\draw (0,4) -- (2.5,4);
\draw (0,3) -- (2.5,3);
\draw (0,2) -- (2.5,2);
\node (e) at (.25,4.5) [vert-small] {{$e_1$}};
\node at (.75,4.5) [vert-small] {};
\node at (1.25,4.5) [vert-small] {{$g_1$}};
\node at (2.25,4.5) [vert-small] {};

\node at (1.75,4.5) {$\cdots$};

\node (e) at (.25,3.5) [vert-small] {{$g_2$}};
\node at (.75,3.5) [vert-small] {};
\node at (1.25,3.5) [vert-small] {};
\node at (2.25,3.5) [vert-small] {};

\node at (1.75,3.5) {$\cdots$};

\node at (1,2.5) {$\vdots$};

\node (e) at (.25,1.5) [vert-small] {};
\node at (.75,1.5) [vert-small] {{$g_n$}};
\node at (1.25,1.5) [vert-small] {};
\node at (2.25,1.5) [vert-small] {};

\node at (1.75,1.5) {$\cdots$};

\node at (4.5,4.5) [vert-small] {{$e_1$}};
\node at (4.5,3.5) [vert-small] {{$h_2$}};
\node at (4.5,1.5) [vert-small] {{$h_n$}};

\node at (4.5,2.5) {$\vdots$};

\node[left] at (-.1,4.5) {$\phi^{-1}(e_H)=\ker(\phi)$};
\node[left] at (-.1,3.5) {$\phi^{-1}(h_2)=g_2\ker(\phi)$};
\node[left] at (-.1,1.5) {$\phi^{-1}(h_n)=g_n\ker(\phi)$};
\node[right] at (5.1,1.5) {\phantom{$\phi^{-1}(h_n)=g_n\ker(\phi)$}};

\draw[|-stealth] (2.6,4.5) to (3.9,4.5);
\draw[|-stealth] (2.6,3.5) to (3.9,3.5);
\node at (3,2.5) {$\vdots$};
\draw[|-stealth] (2.6,1.5) to (3.9,1.5);

\draw (4,1) -- (4,5) -- (5,5) -- (5,1) -- (4,1);
\node (G1) at (1.25,5.2) {$G_1$};
\node (G2) at (4.5,5.2) {$G_2$};
\path (G1) edge [bend left,-stealth] node[above] {$\phi$} (G2);
\end{tikzpicture}
\caption{Left cosets of $\ker(\phi)$ correspond to preimages of elements in range of $\phi$.}
\label{fig:fibers are cosets of ker}
\end{figure}

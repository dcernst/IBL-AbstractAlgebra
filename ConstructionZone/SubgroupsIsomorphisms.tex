...
\begin{section}{Subgroups}\label{sec:Subgroups}
...
$*$    & & & & \cellcolor{cb-lightpurple}$y_1$  & \\ \noalign{\hrule height 2pt}
 & & & &     & \\ \hline
\cellcolor{cb-orange}$x_1$ & & & & \cellcolor{cb-green}$z_1$ & \\ \hline
 & & & &    & \\
 & & & &    &
\end{tabular}
\hspace{1cm}
...
\hspace{1cm}
\begin{tabular}{c!{\vrule width 2pt}ccc|c|c}
$\odot$    & & & & \cellcolor{cb-lightpurple}$y_2$  & \\ \noalign{\hrule height 2pt}
 & & & &     & \\ \hline
\cellcolor{cb-orange}$x_2$ & & & & \cellcolor{cb-green}$z_2$ & \\ \hline
 & & & &    & \\
 & & & &    &
\end{tabular}
\end{center}

...
\begin{exercise}
Justify that $\mathbb{Z}$ is a commutative ring with 1 under the usual operations of addition and mutiplication. Which elements have multiplicative inverses in $\mathbb{Z}$?
\end{exercise}
